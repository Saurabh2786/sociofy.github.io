<div class="background" style="background : url('./assets/images/background.jpg'); height:auto; width:100%;">
    <div class="login">
        <div class="col-lg-4 col-md-8 col-sm-12 bg-rgba(0,0,0,0.5) border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?signup">
                <div class="d-flex justify-content-center">

                    <img class="mb-4" src="assets/images/Sociofy.png" alt="" height="80" width="150">
                </div>
